...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        FocusScopeNode currentFocusedNode = FocusScope.of(context);
        if (!currentFocusedNode.hasPrimaryFocus &&
            currentFocusedNode.focusedChild != null) {
          // currentFocusedNode.focusedChild.unfocus();
